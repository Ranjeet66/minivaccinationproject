...
*         description: Internal server error.
*/
router.put("/adminEditProfile",auth.subJwtToken,adminRouter.adminEditProfile)
/**
* @swagger
...
*         description: Internal server error.
*/
router.put("/adminChangePassword",auth.subJwtToken,adminRouter.adminChangePassword)
/**
* @swagger
...
*         description: Internal server error.
*/
router.get('/adminViewProfile',auth.subJwtToken,adminRouter.adminViewProfile)
