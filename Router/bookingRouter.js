...
*     parameters:
*       - name: token
*         description: sub-Admin Token is required.
*         in: header
*         required: true
*       - name: _id
...
*         description: Internal server error.
*/
router.delete("/cancelSlotByUser",auth.jwtToken,bookingController.cancelSlotByUser)
/**
* @swagger
* /booking/cancelSlotBySAdmin:
*   delete:
*     tags:
*       - VACCINE SLOTS MANAGEMENT
*     description: Creating Docs for VACCINE SLOTS
...
*         description: Internal server error.
*/
router.delete("/cancelSlotBySAdmin",auth.subJwtToken,bookingController.cancelSlotBySAdmin)
/**
* @swagger
